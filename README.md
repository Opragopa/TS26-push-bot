...
В Telegram бот отправляет эти изменения с форматированием: заголовок жирным, название таблицы курсивом, каждое изменение отдельным пунктом, а значения `Было` и `Стало` выделены моноширинным текстом.
